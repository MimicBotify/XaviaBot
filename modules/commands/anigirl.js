...
return requestAnimeImage(api, ZiaRein, ZiaRein2);
}
};

async function requestAnimeImage(api, ZiaRein, ZiaRein2) {
const { event, fs } = api;
const request = global.nodemodule["request"];
const randomImageLink = ZiaRein[Math.floor(Math.random() * ZiaRein.length)];
