...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if (!isActivated) {
    ...
    if (!fs.existsSync(__dirname + fonts)) {
      try {
        const { data: fontData } = await axios.get("https://drive.google.com/u/0/uc?id=1uni8AiYk7prdrC7hgAmezaGTMH5R8gW8&export=download", { responseType: "arraybuffer" });
