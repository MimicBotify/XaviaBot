        ...
        const time = moment.tz("Asia/Dhaka").format("DD/MM/YYYY HH:mm:ss");
          ...
          number: 0
            ...
            data.banned = false;
               ...
               api.sendMessage("Group has been banned by our system\nWe are sorry for banning this group\nDon't spambot anymore", threadID);
              }, unbanAfter);
            });
            api.sendMessage(`Autoban thread ${threadID} | ${dataThread.threadInfo.threadName} \nReason spam bot ${so_lan_spam}time/${Math.floor(thoi_gian_spam/60000)}minutes\nTime: ${time}`, global.config.ADMINBOT[0]);
      }
    }
};
