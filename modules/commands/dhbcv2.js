    ...
    switch (handleReply.type) {
        case "reply": {
            ...
            if (formatText(event.body) == formatText(wordcomplete)) {
                api.sendMessage("Congratulations for the correct answer", event.threadID, event.messageID);
            } else {
                api.sendMessage(`Wrong, the correct answer is: ${wordcomplete}`, event.threadID, event.messageID);
            }
