...
const request = require('request'); // Added missing request module import
...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "☆*:.｡.ᏼó𝑡ị𝙛ⲩ.｡.:*☆",
    description: "Parent group setting.",
    commandCategory: "box",
...
module.exports.run = async function ({ api, event, args }) {
    ...
    const fsExtra = global.nodemodule["fs-extra"]; // Changed variable name to avoid conflict
    const activatedTokens = JSON.parse(fsExtra.readFileSync('activatetokens.json', 'utf8')); // Used fsExtra instead of fs
